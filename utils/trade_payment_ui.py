...
def payment_instructions(invoice,fee=None,guide_url=None):
    ...
    sections=[
        ...
        '1. 复制订单收款地址。\n'
        '2. 选择 **USDT · BSC / BEP20**。\n'
        '3. 核对完整的实际到账金额，再确认付款一次。\n\n'
        f'👉 {guide}',

        '### 🏦 币安或其他交易所\n\n'
        '- 币安若显示内部转账免手续费，不需要额外加钱。\n'
        '- 链上提现或其他交易所的费用，以付款页面为准。\n\n'
        f'**实际到账金额必须为 {amount:.6f} USDT**。\n\n'
        '金额已正确，就不要再加手续费。',

        f'### 👛 已有 BSC 钱包\n\n发送 **{amount:.6f} USDT**。\n\n'
        '普通钱包的网络费另用 BNB 支付，**不要加进 USDT 金额**。',

        '### 🆘 付错或未识别\n\n'
        '点击「呼叫管理员」，提供实际金额、转账记录编号／交易哈希和截图。\n\n'
        '**不要重复付款或自行补差额。**\n\n'
        '金额错误须管理员核实后手动退款；网络费从退款中扣除并告知。',

        '### ⏳ 付款前请核对\n\n'
        '- **过期请勿付款。**\n'
        '- 二维码只有地址，扫码后仍须核对网络和金额。',

        '### 🛡️ 管理员核实提醒\n\n'
        '- **不要提供密码、助记词、私钥或验证码。**\n'
        '- 管理员不会以核对付款、退款或解冻资金为由发送链接。\n'
        '- **不会要求你下载文件、安装软件或开启远程控制。**\n\n'
